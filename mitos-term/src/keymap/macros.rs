...
macro_rules! key {
    ($key:ident) => {
        ::mitos_view::input::KeyEvent {
            code: ::mitos_view::keyboard::KeyCode::$key,
            modifiers: ::mitos_view::keyboard::KeyModifiers::NONE,
        }
    };
    ($($ch:tt)*) => {
        ::mitos_view::input::KeyEvent {
            code: ::mitos_view::keyboard::KeyCode::Char($($ch)*),
            modifiers: ::mitos_view::keyboard::KeyModifiers::NONE,
        }
    };
}
...
macro_rules! shift {
    ($key:ident) => {
        ::mitos_view::input::KeyEvent {
            code: ::mitos_view::keyboard::KeyCode::$key,
            modifiers: ::mitos_view::keyboard::KeyModifiers::SHIFT,
        }
    };
    ($($ch:tt)*) => {
        ::mitos_view::input::KeyEvent {
...
macro_rules! ctrl {
    ($key:ident) => {
        ::mitos_view::input::KeyEvent {
            code: ::mitos_view::keyboard::KeyCode::$key,
            modifiers: ::mitos_view::keyboard::KeyModifiers::CONTROL,
        }
    };
    ($($ch:tt)*) => {
        ::mitos_view::input::KeyEvent {
...
macro_rules! alt {
    ($key:ident) => {
        ::mitos_view::input::KeyEvent {
            code: ::mitos_view::keyboard::KeyCode::$key,
            modifiers: ::mitos_view::keyboard::KeyModifiers::ALT,
        }
    };
    ($($ch:tt)*) => {
        ::mitos_view::input::KeyEvent {
...
macro_rules! keymap {
    ...
    (
        ...
        // modified from the hashmap! macro
        {
            ...
            $(
                $(
                    let _key = $key.parse::<::mitos_view::input::KeyEvent>().unwrap();
