use mitos_core::indent::IndentStyle;
use mitos_core::{coords_at_pos, encoding, unicode::width::UnicodeWidthStr, Position};
use mitos_lsp::lsp::DiagnosticSeverity;
use mitos_view::document::DEFAULT_LANGUAGE_NAME;
use mitos_view::{
...
use mitos_view::editor::StatusLineElement as StatusLineElementID;
...
{
    match element_id {
        mitos_view::editor::StatusLineElement::Mode => render_mode,
        mitos_view::editor::StatusLineElement::Spinner => render_lsp_spinner,
        mitos_view::editor::StatusLineElement::FileBaseName => render_file_base_name,
        mitos_view::editor::StatusLineElement::FileName => render_file_name,
        mitos_view::editor::StatusLineElement::FileAbsolutePath => render_file_absolute_path,
        mitos_view::editor::StatusLineElement::FileModificationIndicator => {
            render_file_modification_indicator
        }
        mitos_view::editor::StatusLineElement::ReadOnlyIndicator => render_read_only_indicator,
        mitos_view::editor::StatusLineElement::FileEncoding => render_file_encoding,
        mitos_view::editor::StatusLineElement::FileLineEnding => render_file_line_ending,
        mitos_view::editor::StatusLineElement::FileIndentStyle => render_file_indent_style,
        mitos_view::editor::StatusLineElement::FileType => render_file_type,
        mitos_view::editor::StatusLineElement::Diagnostics => render_diagnostics,
        mitos_view::editor::StatusLineElement::WorkspaceDiagnostics => render_workspace_diagnostics,
        mitos_view::editor::StatusLineElement::Selections => render_selections,
        mitos_view::editor::StatusLineElement::PrimarySelectionLength => {
            render_primary_selection_length
        }
        mitos_view::editor::StatusLineElement::Position => render_position,
        mitos_view::editor::StatusLineElement::PositionPercentage => render_position_percentage,
        mitos_view::editor::StatusLineElement::TotalLineNumbers => render_total_line_numbers,
        mitos_view::editor::StatusLineElement::Separator => render_separator,
        mitos_view::editor::StatusLineElement::Spacer => render_spacer,
        mitos_view::editor::StatusLineElement::VersionControl => render_version_control,
        mitos_view::editor::StatusLineElement::Register => render_register,
        mitos_view::editor::StatusLineElement::CurrentWorkingDirectory => render_cwd,
        mitos_view::editor::StatusLineElement::CodeActionHint => render_code_action_hint,
    }
}
...
where
    F: Fn(&mut RenderContext<'a>, Span<'a>) + Copy,
{
    use mitos_core::diagnostic::Severity;
...
where
    F: Fn(&mut RenderContext<'a>, Span<'a>) + Copy,
{
    let cwd = mitos_stdx::env::current_working_dir();
    let cwd = cwd
        .file_name()
        .unwrap_or_default()
        .to_string_lossy()
...
use mitos_view::graphics::RectExt as _;
