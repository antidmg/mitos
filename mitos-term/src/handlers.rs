...
pub use mitos_view::handlers::{word_index, Handlers};
...
pub fn setup(config: Arc<ArcSwap<Config>>) -> Handlers {
    ...
    let handlers = Handlers {
        completions: mitos_view::handlers::completion::CompletionHandler::new(event_tx),
        signature_hints,
        auto_save,
        document_colors,
        document_links,
    ...
    mitos_view::handlers::register_hooks(&handlers);
