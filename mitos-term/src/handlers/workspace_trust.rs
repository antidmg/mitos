...
use mitos_loader::workspace_trust::TrustStatus;
use mitos_view::{events::DocumentDidOpen, handlers::Handlers, DocumentId};
...
pub(super) fn register_hooks(_handlers: &Handlers) {
    ...
    register_hook!(move |event: &mut DocumentDidOpen<'_>| {
        ...
        // Stale: `.mitos/` was edited since the user last ran `trust`. LSPs keep
            ...
            match option {
                TrustChoice::Trust => {
                    ...
                    let _ = editor
                        .config_events
                        .0
                        .send(mitos_view::editor::ConfigEvent::Refresh);
                }
                TrustChoice::Never => {
