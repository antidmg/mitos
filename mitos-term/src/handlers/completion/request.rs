...
use mitos_core::completion::CompletionProvider;
use mitos_core::syntax::config::LanguageServerFeature;
use mitos_event::{cancelable_future, TaskController, TaskHandle};
use mitos_lsp::lsp;
use mitos_lsp::lsp::{CompletionContext, CompletionTriggerKind};
use mitos_lsp::util::pos_to_lsp_pos;
use mitos_stdx::rope::RopeSliceExt;
use mitos_view::document::{Mode, SavePoint};
use mitos_view::handlers::completion::{CompletionEvent, ResponseContext};
use mitos_view::{Document, DocumentId, Editor, ViewId};
...
impl mitos_event::AsyncHook for CompletionHandler {
