...
bitflags! {
    ...
    ///
    /// ```rust
    /// # use mitos_view::graphics::Modifier;
    ///
...
///
/// ```rust
/// # use mitos_view::graphics::{Color, Modifier, Style};
/// Style::default()
///     .fg(Color::Black)
///     .bg(Color::Green)
...
///
/// ```rust
/// # use mitos_view::graphics::{Rect, Color, UnderlineStyle, Modifier, Style};
/// # use mitos_tui::buffer::Buffer;
/// let styles = [
...
impl Style {
    ...
    ///
    /// ```rust
    /// # use mitos_view::graphics::{Color, Style};
    ...
    ///
    /// ```rust
    /// # use mitos_view::graphics::{UnderlineStyle, Style};
