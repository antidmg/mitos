...
use mitos_event::{register_hook, AsyncHook, TaskController, TaskHandle};
use mitos_stdx::rope::RopeSliceExt as _;
...
#[cfg(feature = "bench")]
pub mod bench {
    use mitos_core::{Rope, RopeSlice};

    pub use super::WordIndex;

    pub fn add_document(index: &WordIndex, text: &Rope) {
        let mut cancel = mitos_event::TaskController::new();
