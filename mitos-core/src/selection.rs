...
use mitos_stdx::range::is_subset;
use mitos_stdx::rope::{self, RopeSliceExt};
...
impl From<Range> for mitos_stdx::Range {
...
impl Selection {
    ...
    pub fn range_bounds(&self) -> impl Iterator<Item = mitos_stdx::Range> + '_ {
