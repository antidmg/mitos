...
fn test_treesitter_indent_rust_mitos() {
    ...
    for file in files.split_whitespace() {
        ...
        let ignored_lines: Vec<Range<usize>> = match file {
            "mitos-term/src/application.rs" => vec![
            ...
            "mitos-term/src/commands.rs" => vec![
            ...
            "mitos-term/src/commands/dap.rs" => vec![
                // Complex `format!` macro
                46..52,
            ],
            "mitos-term/src/commands/lsp.rs" => vec![
                // Macro
                624..627,
                ...
                878..879,
                // Same as in `mitos-term/src/commands.rs`
                1335..1343,
            ],
            "mitos-term/src/config.rs" => vec![
                // Multiline string
                146..152,
            ],
            "mitos-term/src/keymap.rs" => vec![
                // Complex macro (see above)
                456..470,
                // Multiline string without indent
                563..567,
            ],
            "mitos-term/src/main.rs" => vec![
                // Multiline string
                44..70,
            ],
            "mitos-term/src/ui/completion.rs" => vec![
                // Macro
                218..232,
            ],
            "mitos-term/src/ui/editor.rs" => vec![
            ...
            "mitos-term/src/ui/lsp.rs" => vec![
                // Macro
                56..61,
            ],
            "mitos-term/src/ui/statusline.rs" => vec![
                // Same as in `mitos-term/src/commands.rs`
                436..442,
                450..456,
            ],
