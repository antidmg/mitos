...
* Static commands: commands like `move_char_right` which are usually bound to
  ...
  in [`mitos-term/src/commands.rs`](https://github.com/matoous/mitos/blob/master/mitos-term/src/commands.rs)
...
* Typable commands: commands that can be executed from command mode (`:`), for
  ...
  the source code at [`mitos-term/src/commands/typed.rs`](https://github.com/matoous/mitos/blob/master/mitos-term/src/commands/typed.rs).
