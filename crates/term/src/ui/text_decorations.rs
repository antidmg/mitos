...
use editor_core::doc_formatter::FormattedGrapheme;
use editor_core::Position;
use view::editor::CursorCache;
...
/// [`LineAnnotation`](editor_core::text_annotations::LineAnnotation)s in [`view::View::text_annotations`]
