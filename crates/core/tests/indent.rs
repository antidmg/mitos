...
#[test]
fn test_treesitter_indent_rust_mitos() {
    ...
    for file in files.split_whitespace() {
        ...
        let ignored_lines: Vec<Range<usize>> = match file {
            "crates/term/src/application.rs" => vec![
            ...
            "crates/term/src/commands.rs" => vec![
            ...
            "crates/term/src/commands/dap.rs" => vec![
                // Complex `format!` macro
                46..52,
            ],
            "crates/term/src/commands/lsp.rs" => vec![
                // Macro
                624..627,
                ...
                878..879,
                // Same as in `crates/term/src/commands.rs`
                1335..1343,
            ],
            "crates/term/src/config.rs" => vec![
                // Multiline string
                146..152,
            ],
            "crates/term/src/keymap.rs" => vec![
                // Complex macro (see above)
                456..470,
                // Multiline string without indent
                563..567,
            ],
            "crates/term/src/main.rs" => vec![
                // Multiline string
                44..70,
            ],
            "crates/term/src/ui/completion.rs" => vec![
                // Macro
                218..232,
            ],
            "crates/term/src/ui/editor.rs" => vec![
            ...
            "crates/term/src/ui/lsp.rs" => vec![
                // Macro
                56..61,
            ],
            "crates/term/src/ui/statusline.rs" => vec![
                // Same as in `crates/term/src/commands.rs`
                436..442,
                450..456,
            ],
...
fn test_treesitter_indent(
    ...
    std::env::set_var("MITOS_RUNTIME", runtime.to_str().unwrap());
