...
pub struct LanguageData {
    ...
    spellcheck_query: OnceLock<Option<SpellcheckQuery>>,
}
...
/// multiple lines
    ...
    fn test_subtract_regions() {
        ...
        // Retain a hole that spans several regions, then advance past it for later prose.
        assert_eq!(
            subtract_regions(vec![0..5, 10..15, 20..30], &[2..12, 22..24], 1..27),
            [1..2, 12..15, 20..22, 24..27]
        );
    }
