...
///
/// ```
/// use parsec::{filter_map, take_until, Parser};
...
///
/// ```
/// use parsec::{reparse_as, take_until, one_or_more, Parser};
...
///
/// ```
/// use parsec::{filter, take_until, Parser};
...
///
/// ```
/// use parsec::{zero_or_more, Parser};
