...
impl Client {
    ...
    pub fn start(
        ...
        let cmd = mitos_stdx::env::which(cmd)?;
    ...
    /// (i.e. mitos's *outbound* write completed — independent of how slow the server
    ...
    pub fn text_document_document_color(
        ...
        let params = lsp::DocumentColorParams {
            ...
            partial_result_params: mitos_lsp_types::PartialResultParams {
