# You can move it here ~/.config/elvish/lib/ms.elv
# Or add `eval (slurp < ~/$REPOS/mitos/contrib/completion/ms.elv)`
...
### Set an arg-completer for the `ms` binary
set edit:completion:arg-completer[ms] = {|@args|
  var n = (count $args)
  if (>= $n 3) {
