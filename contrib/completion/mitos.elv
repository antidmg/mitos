# You can move it here ~/.config/elvish/lib/mitos.elv
# Or add `eval (slurp < ~/$REPOS/mitos/contrib/completion/mitos.elv)`
...
### Set an arg-completer for the `mitos` binary
set edit:completion:arg-completer[mitos] = {|@args|
  var n = (count $args)
  if (>= $n 3) {
