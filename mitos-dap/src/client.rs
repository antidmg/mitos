...
use mitos_core::syntax::config::{DebugAdapterConfig, DebuggerQuirks};
use mitos_dap_types::*;
...
impl Client {
    ...
    pub fn call<R: mitos_dap_types::Request>(
        &self,
    ...
    pub async fn request<R: mitos_dap_types::Request>(
        &self,
        params: R::Arguments,
    ) -> Result<R::Result>
    where
    ...
    pub async fn initialize(&mut self, adapter_id: String) -> Result<()> {
        let args = requests::InitializeArguments {
            client_id: Some("mitos".to_owned()),
            client_name: Some("mitos".to_owned()),
            adapter_id,
