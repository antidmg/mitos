...
///
/// ```
/// use mitos_parsec::{take_until, Parser};
...
///
/// ```
/// use mitos_parsec::{take_while, Parser};
...
///
/// ```
/// use mitos_parsec::{choice, or, Parser};
...
///
/// ```
/// use mitos_parsec::{filter_map, take_until, Parser};
...
///
/// ```
/// use mitos_parsec::{reparse_as, take_until, one_or_more, Parser};
...
///
/// ```
/// use mitos_parsec::{filter, take_until, Parser};
...
///
/// ```
/// use mitos_parsec::{optional, Parser};
...
///
/// ```
/// use mitos_parsec::{zero_or_more, Parser};
...
///
/// ```
/// use mitos_parsec::{one_or_more, Parser};
